...
Original file is located at
    https://colab.research.google.com/drive/1zZapLV9su6RHMS78D_GqFEWOn86_9zPN
"""
...
def function12():
    ...
    arr = np.array([1, 2, 3])
    ans =  [arr[j] for j in range(len(arr)) for i in range(len(arr))] # write your code here
    ans=np.concatenate((np.array(ans),np.tile(arr,3)))
    return ans
...
def function20():
    ...
    return  np.apply_along_axis(abc,0,x)# Write your Code here
